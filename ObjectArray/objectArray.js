...
var newArray = products.filter(function (el) {
  return el.unitPrice > 30 && el.unitPrice < 100;
});
console.log(
  " fiyatı 30 ile 100 arasında olan ürünlerin sayısı: " + newArray.length
);

var productsStartingWithA = products.filter(function (product) {
  return product.name.toLowerCase().startsWith("a");
});
console.log("A harfi ile başlayan ürünler: ");
productsStartingWithA.forEach(function (product) {
  console.log(product.name);
});

var productsEndingWithA = products.filter(function (product) {
  return product.name.toLowerCase().endsWith("a");
});
console.log("A harfi ile biten ürünler: ");
productsEndingWithA.forEach(function (product) {
  console.log(product.name);
});

var productsId10 = products.filter(function (product) {
  return (product.id = 10);
});
console.log("Id 10 olanlar: ");
productsId10.forEach(function (product) {
  console.log(product.name);
});

var prodouctDiscountinued = products.filter(function (product) {
  return (product.discontinued = "false");
});
console.log("Discountinued false olanlar: ");
prodouctDiscountinued.forEach(function (product) {
  console.log(product.name);
});

var productWithHighestUnitPrice = products.reduce(function (
  prevProduct,
  currentProduct
) {
  return prevProduct.unitPrice > currentProduct.unitPrice
    ? prevProduct
    : currentProduct;
},
{});
...
console.log(
  "En yüksek fiyatlı ürünün adı: " + productWithHighestUnitPrice.name
);

var productWithLowestUnitPrice = products.reduce(function (
  prevProduct,
  currentProduct
) {
  return prevProduct.unitPrice < currentProduct.unitPrice
...
console.log("En düşük fiyatlı ürünün adı: " + productWithLowestUnitPrice.name);
